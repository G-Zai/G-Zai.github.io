...
`;
  ...
  var background_image = { modern_format: "webp" };
  ...
  var theme_cards = {};
  var params_default = { back_to_top, background_image, bigger_picture, blog, breadcrumb, color, content_panel, css_bundle_name, docs, featured_image, footer, full_width, full_width_types, gallery, header, heading_sign, js_bundle_name, logo, modules, pagination, progress_bar, scrollbar, search, styles, terms, theme_cards };
