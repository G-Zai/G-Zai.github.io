...
`;
  ...
  var params_default = { back_to_top, bigger_picture, blog, breadcrumb, category, categoryid, color, content_panel, css_bundle_name, docs, featured_image, footer, full_width, full_width_types, gallery, header, heading_sign, js_bundle_name, logo, modules, pagination, progress_bar, repo, repoid, scrollbar, search, styles, terms };
