(() => {
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/header/modules/theme-toggle@v0.5.2/assets/hb/modules/header-theme-toggle/init/index.ts
  (() => {
    "use strict";
