(() => {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/snackbar/index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/actions-panel/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/app/index.ts
  var App = class {
    constructor() {
  ...
  // ns-params:@params
  var giscus = { category: "General", categoryid: "DIC_kwDOHJi95s4CTy6q", repo: "G-Zai/Blog", repoid: "R_kgDOHJi95g" };
  var params_default = { analytics: null, archive: { paginate: 20 }, baseURL: "http://localhost:1313/", brand: "HBS", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false }, color: "auto", contact: { endpoint: "https://getform.io/f/56041c81-9e03-4c24-b9c5-61238854d4cd" }, counttaxonomyposts: true, creativecommons: null, customcss: null, customjs: null, dateformat: ":date_long", description: "An extreme fast, responsive and feature-rich blog theme for Hugo", diagram: false, featuredpostcount: 5, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Hugo, Bootstrap, Blog Theme", mainsections: ["blog", "posts", "news", "notes"], palette: "white", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "HBS" } }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/G-Zai/Blog" }, reward: { alipay: "images/reward/alipay.png", wechat: "images/reward/wechat.png" }, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: null, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { email: "GLoadings@outlook.com", github: "G-Zai/Blog" }, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { github: "G-Zai/Blog" } }, viewer: true };

  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/code/code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/code/index.ts
  var Code = class {
    run() {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/docs/catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/docs/index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/local-storage/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/font-size-selector/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/form-validator/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/iframe/index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/loading-bar/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/scroller/index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/sidebar-toggle/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/table-wrapper/index.ts
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/toc/index.ts
  var TOC = class {
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/main/js/components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/slide/index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/search/index.ts
  (() => {
    "use strict";
    var _a, _b;
  ...
  // ns-hugo:/root/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.7/assets/js/mode/index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
