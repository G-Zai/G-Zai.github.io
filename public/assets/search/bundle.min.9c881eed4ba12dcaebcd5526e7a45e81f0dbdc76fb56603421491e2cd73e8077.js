(() => {
  ...
  // ns-hugo:/root/BlogProject/Blog/myblog/themes/hugo-theme-bootstrap/assets/search/search.ts
  ...
  // ns-hugo:/root/BlogProject/Blog/myblog/themes/hugo-theme-bootstrap/assets/search/engine.ts
  var Engine = class {
    fuse;
    pages = [];
    indices = [];
  ...
  // ns-hugo:/root/BlogProject/Blog/myblog/themes/hugo-theme-bootstrap/assets/search/form.ts
  var Form = class {
    constructor(form, callback) {
      this.form = form;
